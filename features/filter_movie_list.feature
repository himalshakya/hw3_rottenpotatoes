...
Scenario: no ratings selected
  ...
  And I press commit
  Then I should see: The Terminator, When Harry Met Sally, Amelie, The Incredibles, Raiders of the Lost Ark, Aladdin, The Help, Chocolat, 2001: A Space Odyssey, Chicken Run
